...
public class TestBase {
    ...
    public TestBase() {                  //Constructor, Same Name as Class - to read properties
        try {
            prop = new Properties();
            FileInputStream ip = new FileInputStream("C:\\Users\\Prakash Udikeri\\IdeaProjects\\CFP - " +
                    "Automation Testing\\FaceBook_POM\\src\\main\\java\\com\\bridgelabz\\pom\\config\\config.properties");
            prop.load(ip);
    ...
    public static void initialization() {
        ...
        System.out.println("Got FB");
    }

    public void keyBoardOperationsEnter(){
        Robot robot = null;
        try {
            robot = new Robot();
